...
FROM OPENROWSET(BULK '/data-mssql/INTERNAL_PARTICIPANTS.xml', SINGLE_BLOB) AS x;
...
INSERT INTO [dbo].[XMLWITHOPENXML](XMLData, LoadedDateTime)
SELECT CONVERT(XML, BulkColumn) AS BulkColumn, GETDATE()
FROM OPENROWSET(BULK '/data-mssql/INTERNAL_PROJECT_ORGANISATIONS.xml', SINGLE_BLOB) AS x;
...
INSERT INTO [dbo].[XMLWITHOPENXML](XMLData, LoadedDateTime)
SELECT CONVERT(XML, BulkColumn) AS BulkColumn, GETDATE()
FROM OPENROWSET(BULK '/data-mssql/ORGANISATION_DATA.xml', SINGLE_BLOB) AS x;
...
INSERT INTO [dbo].[XMLWITHOPENXML](XMLData, LoadedDateTime)
SELECT CONVERT(XML, BulkColumn) AS BulkColumn, GETDATE()
FROM OPENROWSET(BULK '/data-mssql/ORGANISATION_HIERARCHY.xml', SINGLE_BLOB) AS x;
...
INSERT INTO [dbo].[XMLWITHOPENXML](XMLData, LoadedDateTime)
SELECT CONVERT(XML, BulkColumn) AS BulkColumn, GETDATE()
FROM OPENROWSET(BULK '/data-mssql/ORGANISATION_NAME_VARIANTS.xml', SINGLE_BLOB) AS x;
...
INSERT INTO [dbo].[XMLWITHOPENXML](XMLData, LoadedDateTime)
SELECT CONVERT(XML, BulkColumn) AS BulkColumn, GETDATE()
FROM OPENROWSET(BULK '/data-mssql/PERSON_PHOTO_INFORMATION.xml', SINGLE_BLOB) AS x;
...
INSERT INTO [dbo].[XMLWITHOPENXML](XMLData, LoadedDateTime)
SELECT CONVERT(XML, BulkColumn) AS BulkColumn, GETDATE()
FROM OPENROWSET(BULK '/data-mssql/PERSON_PROFILE_INFORMATION.xml', SINGLE_BLOB) AS x;
...
INSERT INTO [dbo].[XMLWITHOPENXML](XMLData, LoadedDateTime)
SELECT CONVERT(XML, BulkColumn) AS BulkColumn, GETDATE()
FROM OPENROWSET(BULK '/data-mssql/PERSON_SAPDATA.xml', SINGLE_BLOB) AS x;
...
INSERT INTO [dbo].[XMLWITHOPENXML](XMLData, LoadedDateTime)
SELECT CONVERT(XML, BulkColumn) AS BulkColumn, GETDATE()
FROM OPENROWSET(BULK '/data-mssql/PROJECT_DATA.xml', SINGLE_BLOB) AS x;
...
INSERT INTO [dbo].[XMLWITHOPENXML](XMLData, LoadedDateTime)
SELECT CONVERT(XML, BulkColumn) AS BulkColumn, GETDATE()
FROM OPENROWSET(BULK '/data-mssql/PROJECT_IDS.xml', SINGLE_BLOB) AS x;
...
INSERT INTO [dbo].[XMLWITHOPENXML](XMLData, LoadedDateTime)
SELECT CONVERT(XML, BulkColumn) AS BulkColumn, GETDATE()
FROM OPENROWSET(BULK '/data-mssql/PROJECT_KEYWORDS.xml', SINGLE_BLOB) AS x;
...
INSERT INTO [dbo].[XMLWITHOPENXML](XMLData, LoadedDateTime)
SELECT CONVERT(XML, BulkColumn) AS BulkColumn, GETDATE()
FROM OPENROWSET(BULK '/data-mssql/PROJECT_PROJECT_RELATION.xml', SINGLE_BLOB) AS x;
...
INSERT INTO [dbo].[XMLWITHOPENXML](XMLData, LoadedDateTime)
SELECT CONVERT(XML, BulkColumn) AS BulkColumn, GETDATE()
FROM OPENROWSET(BULK '/data-mssql/PROJECT_UPMPROJECTTYPES.xml', SINGLE_BLOB) AS x;
...
INSERT INTO [dbo].[XMLWITHOPENXML](XMLData, LoadedDateTime)
SELECT CONVERT(XML, BulkColumn) AS BulkColumn, GETDATE()
FROM OPENROWSET(BULK '/data-mssql/STAFF_ORGANISATION_RELATION.xml', SINGLE_BLOB) AS x;
